...
---
  ...
  <div class="mt-8 mb-8">
    <ProjectCard
      ...
      url="https://github.com/yaotutu/edu-manage-dashboard"
      badge="Hot"
      target="_self"
    />
    <ProjectCard
    ...
    />
    <ProjectCard
      title="Server Lite Monitor"
      image="https://raw.githubusercontent.com/yaotutu/server-lite-monitor/main/assets/preview2.png"
      desc="💻一个轻量级的系统监控面板,专为移动端开发, 可以用来监控你的NAS,Linux服务器,OpenWrt等"
      url="https://github.com/yaotutu/server-lite-monitor"
      badge="Hot"
      target="_self"
    />
  </div>
